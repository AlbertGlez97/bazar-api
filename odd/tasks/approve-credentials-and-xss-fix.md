...
Parent: copy the contract doc to `bazar-frontend/doc/`, native review assessment, then the push decision. This feature file is untracked (the writer did not commit it).
