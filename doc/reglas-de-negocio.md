...
- Formulario público POST /api/v1/business-registration: nombre del negocio, nombre y contacto del socio fundador. Crea una SolicitudNegocio en estado "pendiente" — no se crea ningún contextId ni Member todavía.
