...
| 502 | El correo de credenciales no pudo enviarse (error de Resend distinto del rechazo de modo de prueba, un respaldo al aprobador que también falló, o sin respuesta en el plazo total de 10 s): no se creó nada y la solicitud sigue `pendiente`; se puede reintentar con el mismo enlace | `No se pudo enviar el correo de credenciales` (`La aprobación no se completó y la solicitud sigue pendiente. Vuelve a abrir este mismo enlace para reintentarlo.`) |
| 502 | La transacción de aprobación agotó su tiempo (15 s): no se creó nada y la solicitud sigue `pendiente`; se puede reintentar con el mismo enlace | `La aprobación tardó demasiado` (`Se agotó el tiempo de la operación. La aprobación no se completó y la solicitud sigue pendiente. Vuelve a abrir este mismo enlace para reintentarlo.`) |
| 502 | Otra aprobación tomó el mismo nombre de usuario al mismo tiempo: no se creó nada y la solicitud sigue `pendiente`; el reintento con el mismo enlace deriva un usuario nuevo | `No se pudo crear el usuario` (`Otro registro tomó el mismo nombre de usuario al mismo tiempo. La aprobación no se completó y la solicitud sigue pendiente. Vuelve a abrir este mismo enlace para reintentarlo.`) |
